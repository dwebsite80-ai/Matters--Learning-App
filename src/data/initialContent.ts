...
import { FIRST_AID_LESSONS_PART1, FIRST_AID_QUESTIONS_PART1 } from './firstAidLessonsPart1';
import { FIRST_AID_LESSONS_PART2, FIRST_AID_QUESTIONS_PART2 } from './firstAidLessonsPart2';
import { SURVIVAL_SKILLS_LESSONS_PART1, SURVIVAL_SKILLS_QUESTIONS_PART1 } from './survivalSkillsLessonsPart1';
import { SURVIVAL_SKILLS_LESSONS_PART2, SURVIVAL_SKILLS_QUESTIONS_PART2 } from './survivalSkillsLessonsPart2';
import { MODERN_FARMING_LESSONS_PART1, MODERN_FARMING_QUESTIONS_PART1 } from './modernFarmingLessonsPart1';
import { MODERN_FARMING_LESSONS_PART2, MODERN_FARMING_QUESTIONS_PART2 } from './modernFarmingLessonsPart2';
import { PHILOSOPHY_LESSONS_PART1, PHILOSOPHY_QUESTIONS_PART1 } from './philosophyLessonsPart1';
import { PHILOSOPHY_LESSONS_PART2, PHILOSOPHY_QUESTIONS_PART2 } from './philosophyLessonsPart2';
import { PARADOXES_LESSONS_PART1, PARADOXES_QUESTIONS_PART1 } from './paradoxesLessonsPart1';
import { PARADOXES_LESSONS_PART2, PARADOXES_QUESTIONS_PART2 } from './paradoxesLessonsPart2';
...
export const ALL_LESSONS: Lesson[] = [
  ...
  ...FIRST_AID_LESSONS_PART1,
  ...FIRST_AID_LESSONS_PART2,
  ...SURVIVAL_SKILLS_LESSONS_PART1,
  ...SURVIVAL_SKILLS_LESSONS_PART2,
  ...MODERN_FARMING_LESSONS_PART1,
  ...MODERN_FARMING_LESSONS_PART2,
  ...PHILOSOPHY_LESSONS_PART1,
  ...PHILOSOPHY_LESSONS_PART2,
  ...PARADOXES_LESSONS_PART1,
  ...PARADOXES_LESSONS_PART2,
];
export const ALL_QUESTIONS: Question[] = [
  ...
  ...FIRST_AID_QUESTIONS_PART1,
  ...FIRST_AID_QUESTIONS_PART2,
  ...SURVIVAL_SKILLS_QUESTIONS_PART1,
  ...SURVIVAL_SKILLS_QUESTIONS_PART2,
  ...MODERN_FARMING_QUESTIONS_PART1,
  ...MODERN_FARMING_QUESTIONS_PART2,
  ...PHILOSOPHY_QUESTIONS_PART1,
  ...PHILOSOPHY_QUESTIONS_PART2,
  ...PARADOXES_QUESTIONS_PART1,
  ...PARADOXES_QUESTIONS_PART2,
];
